...
class AI_Pilot():
    ...
    def test(self):
        self.dock_at_dest_clear_log()
        Bot.dock_at_destination_threaded(self.dock_at_dest_append_log, self.ui_element_change)
